...
function deleteStudent(id1) {
    ...
    fetch(siteURL + '/students/' + id1, options).then((response)=>response.json()).then((data)=>getStudents(data)).catch((error)=>console.log(error));
}
...
function getStudents() {
    ...
    fetch(siteURL + '/students', options).then((response)=>response.json()).then((data)=>renderStudents(data)).catch((error)=>console.log("ERROR " + error));
}
...
function addStudent(e) {
    ...
    fetch(siteURL + '/students', options).then((response)=>response.json()).then((data)=>getStudents(data)).catch((error)=>console.log("ERROR " + error));
}
// Функція для оновлення студента
function updateStudent(student, id1) {
    const options = {
        method: "PATCH",
    ...
    fetch(siteURL + '/students/' + id1, options).then((response)=>response.json()).then((data)=>getStudents(data)).catch((error)=>alert('Enter real ID'));
}
...
//# sourceMappingURL=crud-js.672d4772.js.map
